...
$_lang['%addUserClass users added to the class'] = '%addUserClass οι χρήστες έχουν προσθεθεί στην τάξη';
$_lang['%addUserCourse users added to the course'] = '%addUserCourse οι χρήστες έχουν προσθεθεί στο μάθημα';
...
$_lang['%firstname %lastname has not been added !'] = '%firstname %lastname δεν προσθέθηκε!';
...
$_lang['%nb_user not to add'] = '%nb_user δεν θα προσθεθεί';
$_lang['%newUser users added to the campus'] = '%newUser οι χρήστες έχουν προσθεθεί στο πανεπιστήμιο';
...
$_lang['Access allowed only to course members (people on the course user list)'] = 'Η πρόσβαση επιτρέπεται μόνο στα μέλη του μαθήματος (ανθρώπους στην λίστα χρηστών)';
$_lang['Access allowed only to platform members (user registered to the platform)'] = 'Η πρόσβαση επιτρέπεται μόνο στα μέλη της πλατφόρμας (εγγεγραμμένους χρήστες στην λίστα)';
$_lang['Access allowed to anybody (even without login)'] = 'Η πρόσβαση επιτρέπεται σε όλους (χώρις όνομα χρήστη και κωδικό)';
$_lang['Access control management'] = ' Διαχείριση ελέγχου πρόσβασης ';
$_lang['Access count'] = 'Αριθμός προσβάσεων';
$_lang['Access to course'] = 'Πρόσβαση σε μάθημα';
$_lang['Access to platform'] = 'Πρόσβαση στη πλατφόρμα';
$_lang['Accounts to merge'] = 'Λογαριασμοί χρηστών για συγχώνευση';
...
$_lang['Activate module on install'] = 'Ενεργοποίηση ενότητας στην εγκατάσταση';
$_lang['Activate on course creation'] = 'Ενεργοποίηση στην δημιουργία του μαθήματος';
...
$_lang['Add a "Download all submissions" link in the teacher commands'] = 'Πρόσθεσε ένα σύνδεσμο \"Κατέβασε όλες τις υποβολές αιτήσεων\" στις εντολές του δασκάλου';
$_lang['Add a category'] = 'Προσθήκη κατηγορίας';
$_lang['Add a comment'] = 'Προσθήκη / αλλαγή σχολίου στο';
$_lang['Add a comment (optional)'] = 'Πρόσθεσε ένα σχόλιο (προαιρετικό)';
...
$_lang['Add additional tools in the SDK section of the platform administration.'] = 'Πρόσθεσε επιπρόσθετα εργαλεία στην ενότητα SDK στην διαχείριση της πλατφόρμας';
$_lang['Add an event'] = 'Προσθήκη ενός γεγονότος';
$_lang['Add an exercise'] = 'Εισαγωγή της άσκησης μου';
$_lang['Add an image'] = 'Πρόσθεσε μια εικόνα';
...
$_lang['Add external links to your course'] = 'Πρόσθεσε εξωτερικούς συνδέσμους στο μάθημα σου';
...
$_lang['Add or remove tools'] = 'Πρόσθεσε ή αφαίρεσε εργαλεία';
$_lang['Add or remove tools from your course'] = 'Πρόσθεσε ή αφαίρεσε εργαλεία απο το μάθημα σου';
$_lang['Add to course'] = 'Πρόσθεσε στο μάθημα';
...
$_lang['Alignment'] = 'Στοίχιση';
$_lang['All'] = 'Όλα';
$_lang['All (Read or not)'] = 'Όλα ( Διαβασε ή όχι)';
$_lang['All events before %date have been successfully deleted'] = 'Όλα τα γεγονότα πριν απο %date έχουν επιτυχημένα διαγραφεί ';
$_lang['All events deleted from the agenda'] = 'Όλα τα γεγονότα έχουν διαγραφεί ημερήσια διάταξη';
...
$_lang['All messages'] = 'Όλα τα μηνύματα';
$_lang['All messages from a user'] = 'Όλα τα μηνύματα απο ένα χρήστη';
$_lang['All messages have been deleted'] = 'Όλα τα μηνύματα έχουν διαγραφεί';
$_lang['All messages in date interval'] = 'Όλα τα μηνύματα ενδιάμεσα κάποιων ημερομηνιών';
$_lang['All messages older than'] = 'Όλα τα μηνύματα παιλαιότερα απο';
$_lang['All messages older than %date% have been deleted'] = 'Όλα τα μηνύματα παλαιότερα απο %date% έχουν διαγραφεί';
...
$_lang['All platform messages'] = 'Όλα τα μηνύματα της πλατφόρμας';
$_lang['All platform messages have been deleted'] = 'Όλα τα μηνύματα της πλατφόρμας έχουν διαγραφεί';
$_lang['All profiles'] = 'Όλα τα προφίλ';
$_lang['All submissions'] = 'Όλες οι υποβολές αιτήσεων';
$_lang['All user\'s message have been deleted'] = 'Το μήνυμα του χρήστη έχει διαγραφεί';
$_lang['All users have been sucessfully unregistered from the class'] = 'Όλοι οι χρήστες έχουν απεγγραφεί επιτυχώς από την τάξη';
$_lang['All users of the platform'] = 'Όλοι οι χρήστες της πλατφόρμας';
...
$_lang['Allow teacher to download all submissions'] = 'Επέτρεψε στον δάσκαλο να κατεβάσει όλες τις υποβολές αιτήσεων';
...
$_lang['Allow user to add a picture to their profile'] = 'Επέτρεψε στον χρήστη να προσθέσει φωτογραφία στο προφίλ του';
...
$_lang['Allowed with enrolment key'] = 'Επιτρεπόμενο με κλειδί εγγραφής';
$_lang['Already browsed'] = 'ήδη αναζητήθηκε';
$_lang['Already enroled'] = 'ήδη εγγεγραμένος';
$_lang['Also delete module main database'] = 'Επίσης διάγραψε την ενότητα της κύριας βάσης δεδομένων';
...
$_lang['An error occurred.  Learning Path import failed.'] = 'Εμφανίστηκε σφάλμα. Η εισαγωγή της διαδρομής εκμάθησης απότυχε';
$_lang['An invisible tool will be greyed out on your personal interface.'] = 'Ένα αόρατο εργαλείο θα είναι πιο γκρίζο στην προσωπική σου πύλη';
...
$_lang['Are you sur to delete user\'s message?'] = 'Είσαι σίγουρος για την διαγραφή του μηνύματος του χρήστη';
$_lang['Are you sure to delete'] = 'Είστε βέβαιος ότι θέλετε να το διαγράψετε';
$_lang['Are you sure to delete "%title" ?'] = 'Είσαι σίγουρος ότι θέλεις να διαγράψεις το \"%title\";';
$_lang['Are you sure to delete all messages from this user'] = 'Είσαι σίγουρος ότι θέλεις να διαγράψεις όλα τα μηνύματα απο αυτόν τον χρήστη';
$_lang['Are you sure to delete all messages older than %date?'] = 'Είσαι σίγουρος ότι θέλεις να διαγράψεις όλα τα μηνύματα που είναι παλαιότερα απο %date;';
$_lang['Are you sure to delete all messages?'] = 'Είσαι σίγουρος ότι θέλεις να διαγράψεις όλα τα μηνύματα;';
$_lang['Are you sure to delete all platform messages?'] = 'Είσαι σίγουρος ότι θέλεις να διαγράψεις όλα τα μηνύματα της πλατφόρμας;';
$_lang['Are you sure to delete selected message(s) ?'] = 'Είσαι σίγουρος ότι θέλεις να διαγράψεις το(α) επιλεγμένο(α) μηνύμα(τα);';
$_lang['Are you sure to delete selected message?'] = 'Είσαι σίγουρος ότι θέλεις να διαγράψεις  το επιλεγμένο μηνύμα';
...
$_lang['Are you sure to delete the message?'] = 'Είσαι σίγουρος ότι θέλεις να διαγράψεις το μηνύμα';
$_lang['Are you sure to delete this group ?'] = ' Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτήν την ομάδα?';
$_lang['Are you sure to empty trashbox ?'] = 'Είσαι σίγουρος ότι θέλεις να αδειάσεις τον κάλαθο;';
...
$_lang['Are you sure you want to delete module %module% ?'] = 'Είσαι σίγουρος ότι θέλεις να διαγράψεις την ενότητα  %module% ;';
...
$_lang['Available images'] = 'Διαθέσιμες εικόνες';
$_lang['Available tools to add to your course'] = 'Διαθέσιμα εργαλεία για να προσθέσεις στο μάθημα σου';
...
$_lang['Back to inbox'] = 'Πίσω στα εισερχόμενα';
...
$_lang['Baseline'] = 'Γραμμή εκκίνησης';
$_lang['Before'] = 'Πρίν';
...
$_lang['Cannot add tool to course'] = 'Δεν μπορεί να προσθέσει το εργαλείο στο μάθημα';
$_lang['Cannot be changed'] = 'Δεν μπορεί να αλλαχτεί';
$_lang['Cannot change module activation on course creation'] = 'Δεν μπορεί να αλλάξει την ενεργοποίηση της ενότητας στην δημιουργία του μαθήματος';
$_lang['Cannot change module visibility in %course'] = 'Η κατάσταση εμφάνισης του module δεν μπορεί να αλλάξει στο μάθημα %course';
$_lang['Cannot compute db size of a course in singleDBMode'] = 'Δεν μπορεί να υπολογίσει το μέγεθος της βάσης δεδομένων σε μάθημα σε κανονικό τρόπο προβολής';
...
$_lang['Cannot delete announcement'] = 'Δεν μπορεί να διαγράφει η ανακοίνωση';
$_lang['Cannot delete announcement list'] = 'Δεν μπορεί να διαγράφει η λίστα ανακοίνωσεων';
$_lang['Cannot delete user picture'] = 'Δεν μπορεί να διαγράφει η φωτογραφία του χρήστη';
...
$_lang['Cannot find user'] = 'Δεν μπορεί να βρεθεί ο χρήστης';
$_lang['Cannot load portlets'] = 'Δεν μπορεί να κατεβάσει τα portlets';
$_lang['Cannot merge one user account with itself'] = 'Δεν μπορεί να συγχωνεύσει ένα λογαρισμό χρήστη με τον εαυτό του';
$_lang['Cannot open %filename'] = '%filename δεν μπορεί να ανοιχθεί';
$_lang['Cannot open manifest file'] = 'Δεν μπορεί να ανοίξει το αρχείο manifest';
$_lang['Cannot parse module manifest'] = 'Δεν μπορεί να κωδικοποιήσει την ενότητα manifest';
$_lang['Cannot perform the requested action'] = 'Δεν μπορεί να εκτελεθεί η ζητούμενη ενέργεια';
...
$_lang['Cannot remove tool from course'] = 'Δεν μπορεί να αφαιρεθεί το εργαλείο απο το μάθημα';
...
$_lang['Cannot upload file'] = 'Δεν μπορεί να ανεβεί το αρχείο';
...
$_lang['Change visibility in all courses'] = 'Άλλαξε την ορατότητα σε όλα τα μαθήματα';
...
$_lang['Changes have not been applied to the user settings'] = 'Οι αλλαγές δεν εφαρμόστηκαν στις ρυθμίσεις του χρήστη';
...
$_lang['Choose the mode for URL for file download. Warning : Pretty URL mode don\'t work with IIS.'] = 'Επιλέξτε το τρόπο για κατέβασμα του αρχείου απο την διευθυνση. Προειδοποίηση: Όμορφοι τρόποι διεύθυνσης δεν δουλεύουν με τον IIS';
$_lang['Chosen date is in the future'] = 'Η επιλεγμένη ημερομηνία είναι στο μέλλον';
$_lang['Clarodoc'] = 'Clarodoc';
$_lang['Claroline configuration'] = 'Ρυθμίσεις Κλάρολαιν';
...
$_lang['Clear up event list ?'] = 'Να καθαριστεί η λίστα γεγονότων;';
...
$_lang['Click on exercise title for more details'] = 'Κάντε κλίκ στο τίτλο της άσκησης για περισσότερες πληροφορίες';
...
$_lang['Click on the month name for tool access details'] = 'Κάντε κλίκ στο μήνα για να έχετε πρόσβαση στις λεπτομέρειες των εργαλείων.';
...
$_lang['Compare 1.8 to 1.9'] = 'Σύγκρίνω το 1.8 με το 1.9';
$_lang['Complementary fields'] = 'Αλληλεξαρτημένα πεδία';
$_lang['Complete language files'] = 'Ολοκλήρωση αρχείων γλώσσας';
$_lang['Compose a message'] = 'Δημιουργία μηνύματος';
$_lang['Compress javascript files. This option should be set to off only for debugging.'] = 'Συμπιέστε τα αρχεία JavaScript. Αυτή η επιλογή πρέπει να τεθεί στο Off μόνο για debugging.';
$_lang['Configuration'] = 'Διαμόρφωση';
$_lang['Configure the way files are downloaded from the platform'] = 'Ρυθμίστε τον τρόπο που τα αρχεία καταβείνουν απο την πλατφόρμα';
...
$_lang['Constrain proportions'] = 'Αναγκάστικές αναλογίες';
...
$_lang['Conversion 1.8 to 1.9'] = 'Μετατροπη απο 1.8 σε 1.9';
...
$_lang['Course created : %course_name'] = 'Το μάθημα δημιουργήθηκε : %course_name';
$_lang['Course creation is allowed on the platform'] = 'Η δημιουργία μαθημάτων επιτρέπεται στην πλατφόρμα';
$_lang['Course creation is disabled on the platform'] = 'Η δημιουργία μαθημάτος δεν επιτρέπεται στην πλατφόρμα';
$_lang['Course creator'] = 'Δημιουργός του μαθήματος';
$_lang['Course creator status for %firstname %lastname'] = 'Κατάσταση δημιουργού για %firstname %lastname';
$_lang['Course default settings'] = 'Προκαθορισμένες ρυθμίσεις μαθήματος';
$_lang['Course description'] = 'Περιγραφή μαθήματος';
$_lang['Course email is'] = 'Η email διεύθυνση του μαθήματος είναι';
$_lang['Course information requirements'] = 'Προαπαιτούμενες πληροφορίες μαθήματος';
$_lang['Course list'] = 'Λίστα μαθημάτων';
$_lang['Course main settings'] = 'Βασικές ρυθμίσεις μαθήματος';
...
$_lang['Course manager of %course%(%courseCode%)'] = 'Διαχειριστής μαθήματος %course%(%courseCode%)';
...
$_lang['Course statistics are now empty'] = 'Οι στατιστική του μαθήματος είναι τώρα άδεια';
...
$_lang['Course visibility'] = 'Ορατότητα μαθήματος';
...
$_lang['Courses : %disk_usage (perhaps with other directories)'] = 'Μαθήματα : %disk_usage (πιθανών με άλλους καταλόγους)';
...
$_lang['Create fake categories'] = 'Δημιούργησε ψεύτικες κατηγορίες';
$_lang['Create fake courses'] = 'Δημιούργησε ψεύτικα μαθήματα';
$_lang['Create fake users'] = 'Δημιούργησε ψεύτικους χρήστες';
...
$_lang['Create item into courses tools'] = 'Δημιούργησε αντικείμενο στα εργαλεία μαθημάτων';
...
$_lang['Data checking'] = 'Έλεγχος δεδομένων';
...
$_lang['Database uninstallation skipped'] = 'Απεγκατάσταση βάσης δεδομένων παραλήφθηκε';
...
$_lang['Default course enrolment'] = 'Προκαθορισμένη εγγραφή μαθήματος';
$_lang['Default course visibility'] = 'Προκαθορισμένη ορατότητα μαθήματος';
...
$_lang['Delete all messages'] = 'Διαγραφή όλων των μηνυμάτων';
$_lang['Delete all messages of'] = ' Διαγράψτε όλα τα μηνύματα ';
$_lang['Delete all user\'s messages'] = 'Διαγραφή όλων των μηνυμάτων χρήστη';
$_lang['Delete attached file'] = 'Διαγραφή επισυναπτόμενου αρχείου';
$_lang['Delete course allowed'] = 'Διαγραφή μαθήματος επιτράπηκε';
$_lang['Delete is definitive.  There is no way to get your data back after delete.'] = 'Η διαγραφή είναι μη αποτρέψιμη.Δεν υπάρχει κανένασ τρόπος να επανακτήσετε τα δεδομένα σας μετα την διαγραφή.';
$_lang['Delete messages'] = 'Διαγραφή μηνυμάτων';
$_lang['Delete messages older than'] = 'Διαγραφή μηνυμάτων παλαιότερα απο';
$_lang['Delete my account'] = 'Διαγραφή του λογαριασμού μου';
$_lang['Delete picture'] = 'Διαγραφή φωτογραφίας';
$_lang['Delete platform messages'] = 'Διαγραφή μηνυμάτων πλατφόρμας';
$_lang['Delete scripts of the module'] = 'Διαγραφή των scripts απο το module';
$_lang['Delete selected message(s)'] = 'Διαγραφή επιλεγμένου(ων) μηνυμάτος(ων)';
...
$_lang['Denotes required fields'] = 'Δηλώνει απαιτούμενο πεδίο';
...
$_lang['Description added'] = 'Η περιγραφή έχει προσθεθεί';
...
$_lang['Dimensions'] = 'Διαστάσεις';
$_lang['Direct link to image'] = 'Απευθεία σύνδεση σε εικόνα';
$_lang['Directory created'] = 'Ο κατάλογος δημιουργήθηκε';
$_lang['Directory name'] = 'Όνομα καταλόγου';
$_lang['Disable'] = 'Αδύνατο';
$_lang['Disable this option if you are not using the local Claroline password to identify a user'] = 'Απενεργοποίησε αυτή την επιλογή αν δεν χρησιμοποιείς το τοπικό κωδικό του Κλάρολαιν για να αναγνωρίσεις ένα χρήστη';
...
$_lang['Display a link to the lost password form'] = 'Πρόβαλε ένα σύνδεσμο για την φόρμα χαμένου κωδικού';
$_lang['Display all feedbacks'] = 'Πρόβαλε όλες τις ανατροφοδοτήσεις';
...
$_lang['Display of detailed answers is not authorized.'] = 'Η προβολή λεπτομερών απαντήσεων δεν είναι εξουσιοδοτημένη';
...
$_lang['Do you really want to delete the "%categoryCode%" category ?'] = 'Είσε σίγουρος ότι θέλεις να διαγράψεις το  \"%categoryCode%\" απο τηνκατηγορία;';
...
$_lang['Done'] = 'Έγινε';
$_lang['Download'] = 'Κατέβασε';
$_lang['Download current directory'] = 'Αποθήκευσε τον τρέχοντ κατάλογο';
$_lang['Download file'] = 'Αποθήκευσε το αρχείο';
$_lang['Download mechanism'] = 'Μηχανισμός κατεβάσματος';
$_lang['Download submissions'] = 'Κατάβασε τις υποβολές αιτήσεων';
$_lang['Downloads'] = 'Κατεβάσματα';
$_lang['E-mail'] = 'E-mail';
...
$_lang['Edit'] = 'Διόρθωση';
$_lang['Edit <i>%filename</i>'] = 'Επεξεργασία <i>%filename</i>';
...
$_lang['Edit forum'] = 'Επεξεργασία συζητήσης';
...
$_lang['Empty manifest'] = 'Άδειασε το manifest';
$_lang['Empty trashbox'] = 'Άδειασε τον κάλαθο';
$_lang['Empty your trashbox?'] = 'Να αδειάσει ο κάλαθος σου;';
$_lang['Enable CAS system'] = 'Ενεργοποίησε το σύστημα CAS';
$_lang['Enable Email notification'] = 'Ενεργοποίησε την ειδοποίηση μέσω email.';
...
$_lang['Enable cache'] = 'Ενεργοποίηση του cache';
$_lang['Enable iCal in course'] = 'Ενεργοποιησε το iCal στο μάθημα';
$_lang['Enabling the cache may increase performance'] = 'Η ενεργοποίηση του cache μπορεί να αυξήσει την απόδοση';
$_lang['Encrypt exported password using md5 algorithm'] = 'Κωδικοποίησε τους εξαγώμενους κωδικούς χρησιμοποιώντας αλγόριθμο md5';
...
$_lang['Enrol to %course'] = 'Εγγραφή στο %course';
...
$_lang['Error : cannot read RSS feed (Check feed url and if php setting "allow_url_fopen" is turned on).'] = 'Σφάλμα : δεν μπορεί να διαβάσει το RSS feed ( Έλεξε την διευθυνση του Feed και βεβαιωθείτε ότι η επιλογή \"allow_url_fopen\" ειναι ενεργοποιημένη)';
...
$_lang['Error while deleting module files'] = 'Σφάλμα κατα την διαγραφή των αρχείων της ενότητας';
$_lang['Error while deleting the scripts of the module'] = 'Σφάλμα κατά τη διαγραφή των scripts από το module';
$_lang['Error while parsing manifest'] = 'Σφάλμα κατα το parsing του manisfest';
...
$_lang['Exact expression'] = 'Ακριβής έκφραση';
...
$_lang['Export password'] = 'Εξαγωγή κωδικού';
$_lang['Export user list'] = 'Εξαγωγή λίστας χρηστών';
$_lang['Export username'] = 'Εξαγωγή ονομάτων χρήστη';
...
$_lang['Fetch and install module'] = 'Πιάσε και εγκαστάστησε την ενότητα';
...
$_lang['File cannot be moved there'] = 'Το αρχείο δεν μπορεί να μετακινηθεί εδώ';
...
$_lang['File download failed : %failureMSg%'] = 'Παρουσιάστηκε σφάλμα στο κατέβασμα του αρχείου : %failureMSg%';
...
$_lang['File url mode'] = 'Τρόπος επιλογής διεύθυνσης αρχείου';
...
$_lang['Fill in one or more search criteria, select user profile parameters for your course and press \'Search\''] = 'Εισάγετε ένα ή περισσότερα κριτήρια έρευνας, επιλέξτε παραμέτρους για το προφίλ χρήστη για το μάθημα σας και κάντε κλίκ στο \'Έρευνα\'';
...
$_lang['Go to config'] = 'Πήγαινε στο Config';
...
$_lang['Horizontal space'] = 'Οριζόντιο διάστημα';
$_lang['Host name'] = 'Όνομα ιστοσελίδας';
$_lang['Host of CAS server'] = 'Ιστοσελίδα του CAS server';
$_lang['Hour'] = 'Ώρα';
$_lang['Icon'] = 'Εικονίδιο';
$_lang['Id'] = 'Κωδικός';
$_lang['Id of the user to keep'] = 'Κωδικός χρήστη για να κρατηθεί';
$_lang['Id of the user to remove'] = 'Κωδικός χρήστη για να αφαιρεθεί';
$_lang['Identical content<br />no modification saved'] = ' Ίδιο περιεχόμενο <br />καμιά αλλαγή δεν αποθηκεύτηκε';
$_lang['If activated course administrator will receive an email every time a submission is made.  Students will receive an email advising them that their work has been marked.'] = 'Αν ενεργοποιηθεί ο διαχειριστής του μαθήματος θα λαμβάνει ένα μήνυμα ηλεκτρονικου ταχυδρομείου κάθε φορά που γίνετε μια υποβολή αίτησης. Οι μαθητές θα λαμβάνουν μήνυμα ηλεκτρονικού ταχυδρομείου κάθε φορά που βαθμολογείτε η εργασία τους.';
$_lang['If activated, all the feedbacks will be shown to users; if not, only those corresponding to the selected or correct answers will be displayed'] = 'Αν ενεργοποιηθεί, όλες οι ανατροφοδοτήσεις θα φαίνονται στους χρήστες. Αν όχι, μόνο αυτές που αντοποκρίνονται στο επιλεγμενο και οι σωστές απαντήσεις θα εμφανίζονται.';
...
$_lang['If false, other fields are optional'] = 'Αν λανθασμένο, όλα τα άλλα πεδία είναι προαιρετικά';
...
$_lang['If the user is existing in the platform, he will be added to the class only if his firstname, 
                                        lastname and username are similar.'] = 'Αν ο χρήστης είναι παρών στην πλατφόρμα, θα προσθέτετε στην τάξη αν το όνομα και το επίθετο και το όνομα χρήστη είναι όμοια.';
$_lang['If the user is existing in the platform, he will be added to the course only if his firstname, 
                                        lastname and username are similar.'] = 'Αν ο χρήστης είναι παρών στην πλατφόρμα, θα προσθέτετε στο μάθημα αν το όνομα και το επίθετο και το όνομα χρήστη είναι όμοια.';
$_lang['If you are not using the local Claroline password to identify a user, disable this option so the access authentication form will not be available'] = 'Αν δεν χρησιμοποιήτε το τοπικο κωδικό του Κλάρολαιν για να αναγνωρίσετε ένα χρήστη, απενεργοποιήστε αυτή την επιλογή έτσι ώστε η πρόσβαση στην φόρμα επικύρωσης να μην είναι διαθέσιμη';
$_lang['If you can\'t read this message go to:'] = 'Αν δεν μπορείς να διαβάσεις αυτό το μήνυμα πήγαινε στο:';
...
$_lang['Image URL'] = 'Διεύθυνση εικόνας';
$_lang['Image Viewer'] = 'Εφαρμογή Προβολής Εικόνων';
$_lang['Image description'] = 'Περιγραφή εικόνας';
$_lang['Image is too big : max size %width%x%height%, %size% bytes'] = 'Η εικόνα είναι πολύ μεγάλη: μέγιστο μέγεθος %width%x%height%, %size% μπάιτς';
$_lang['Image manager'] = 'Διαχειριστής φωτογραφίας';
...
$_lang['Imported modules must be compatible with your Claroline version.'] = 'Οι εισαγώμενες ενότητες πρέπει να είναι συμβατές με την έκδοση του Κλαρολαιν σου';
...
$_lang['In iCal an event has a duration but not in claroline. 3600 seconds = 1 Hour.'] = 'Στο iCal ένα γεγονός έχει διάρκεια αλλά όχι στο Κλάρολαιν. 3600 δευτερόλεπταs = 1 ώρα.';
...
$_lang['Install this module'] = 'Εγκατάσταση αυτής της ενότητας';
$_lang['Institution'] = 'Οργανισμός (institution)';
$_lang['Institution URL'] = 'URL Οργανισμού';
$_lang['Internal messaging'] = 'Εσωτερική αλληλογραφία';
$_lang['Internal messaging system'] = 'Σύστημα εσωτερικής αλληλογραφίας';
$_lang['Invalid Wiki Id'] = 'Μη έγκυρο Wiki Id';
$_lang['Invalid answer'] = 'Αδύνατη απάντηση';
$_lang['Invalid date'] = 'Λανθασμένη ημερομηνία';
$_lang['Invalid file format, use gif, jpg or png'] = 'Λανθασμένος τύπος αρχείου, χρησιμοποίησε  gif, jpg ή png';
$_lang['Invalid matching choice'] = 'Αδύνατη αντιστοίχιση επιλογής';
$_lang['Invalid question'] = 'Αδύνατη ερώτηση';
$_lang['Invalid section'] = 'Λανθασμένη ενότητα';
...
$_lang['Javascript compression'] = 'Συμπίεση Javascript ';
...
$_lang['Last %numberOfMessages messages'] = 'Τελευταία %numberOfMessages μηνύματα';
...
$_lang['Last download'] = 'Τελευταίο κατέβασμα';
...
$_lang['Loaded extensions'] = 'Κατεβασμένες επεκτάσεις';
...
$_lang['Logout'] = 'Έξοδος';
$_lang['Logout user from CAS server when user logout from Claroline'] = 'Αποσύνδεσε το χρήστη απο τον εξυπηρέτη CAS  όταν ο χρήστης αποσυνδεθεί απο το Κλάρολαιν';
...
$_lang['Makes TinyMCE 75% smaller and a lot faster to load.'] = 'Κάνει το TinyMCE 75% μικρότερο και πολύ πιο γρήγορότερο στο κατέβασμα.';
$_lang['Manage Right'] = 'Διαχείριση Δεξιού μέρου';
$_lang['Manage administrator email notifications'] = 'Διαχείριση ειδοποιήσεων ηλεκτρονικού ταχυδρομείου  διαχειριστή';
$_lang['Manage classes'] = 'Διαχείριση τάξεων';
$_lang['Manage course categories'] = 'Διαχείριση κατηγοριών μαθήματος';
$_lang['Manage external links'] = 'Διαχείριση εξετερικών συνδέσμων';
$_lang['Manage tool access rights'] = 'Διαχείριση ελέγχου πρόσβασης εργαλειών';
$_lang['Manage user desktop'] = 'Διαχείριση επιφάνειας εργασίας χρήστη';
...
$_lang['Manual'] = 'Βιβλίο οδήγησης';
$_lang['Match the exact expression'] = 'Ταυτοποίησε την ακριβή έκφραση';
$_lang['Matching'] = 'Αντιστοίχιση';
$_lang['Mathematical renderer URL'] = 'Διεύθυνση URL του μαθηματικού επεξεργαστή';
$_lang['Max announcement number in portlet'] = 'Μέγιστος αριθμός ειδοποιήσεων στην πύλη';
...
$_lang['Merge'] = 'Συγχώνευση';
$_lang['Merge user accounts'] = 'Συγχώνευση λογαριασμών χρήστη';
$_lang['Merging user accounts is not a reversible operation so be careful !'] = 'Η συγχώνευση λογαρισμών χρηστών είναι μη επιστρέψιμη ενέργεια, γι\' αυτο να είστε προσεκτικοί!';
$_lang['Merging users will alter the user data and cannot be undone. Are you sure to want to continue ?'] = 'Η συγχώνευση όλων το χρηστών θα αλλάξει όλα τα δεδομένα του χρήστη και δεν μπορεί να επιστρέψει στην αρχική κατάσταση. Είσαι σίγουρος ότι θέλεις να συνεχίσεις;';
$_lang['Message'] = 'Μήνυμα';
$_lang['Message body'] = 'Σώμα μηνύματος';
$_lang['Message from your lecturer'] = 'Mήνυμα απο τον λέκτορα σου ';
$_lang['Message not found'] = 'Το μήνυμα δεν βρέθηκε';
$_lang['Message sent'] = 'Μήνυμα στάλθηκε';
$_lang['Messages'] = 'Mηνύματα';
$_lang['Messages of %firstName %lastName'] = 'Μηνύματα του %firstName %lastName';
...
$_lang['Missing parameter : %param%'] = 'Παραλειπόμενη παράμετρος : %param%';
$_lang['Missing parameters'] = 'Λείπουν παράμετροι';
$_lang['Missing search keywords'] = 'Λείπουν λέξεις αναζήτησης';
$_lang['Missing tool label'] = 'Παραλειπόμενη ετικέτα εργαλείου';
...
$_lang['Module %claroLabel registered'] = 'Η Ενότητα %claroLabel έχει εγγραφεί';
$_lang['Module %label added in dock : %dock'] = 'Η ενότητα %label έχει προσθεθεί στην πύλη : %dock';
$_lang['Module %label registered as tool'] = 'Η ενότητα %label έχει εγγραφεί ώς εργαλείο : %dock';
$_lang['Module %module is already installed on your platform'] = 'Το Module %module είναι ήδη εγκατεστημένο στην πλατφόρμα';
$_lang['Module activation at course creation set to AUTOMATIC'] = 'Η ενεργοποίηση της ενότητας στην δημιουργία μαθημάθων έχει τεθεί ώς ΑΥΤΟΜΑΤΗ';
$_lang['Module activation at course creation set to MANUAL'] = 'Η ενεργοποίηση της ενότητας στην δημιουργία μαθημάθων έχει τεθεί ώς ΧΕΙΡΟΚΙΝΗΤΗ';
...
$_lang['Module catching failed. Check your path'] = 'Το πιάσιμο της ενότητας απέτυχε. Παρακαλώ ελέξτε την διαδρομή σας';
$_lang['Module deactivation succeeded'] = 'Η απενεργοποίηση του module πέτυχε';
$_lang['Module desactivation failed'] = 'Η απενεργοποίηση της ενότητας απέτυχε.';
$_lang['Module desactivation succeeded'] = 'Η απενεργοποίηση της ενότητας πέτυχε';
$_lang['Module directory not found'] = 'Δεν μπορεί να βρεθεί ο κατάλογος του module';
$_lang['Module files deleted'] = 'Τα αρχεία της ενότητας διαγράφηκαν
';
...
$_lang['Month'] = 'Mήνας';
$_lang['More active topics'] = 'Περισσότερα ενεργά θέματα';
$_lang['More read topics'] = 'Περισσότερα διαβασμένα θέματα';
$_lang['More verbose when error occurs.'] = 'Περισσότερες πληροφορίες όταν προκύπτουν λάθη.';
$_lang['Most recently active topics'] = 'Πιο πρόσφατα ενεργά θέματα';
$_lang['Move'] = 'Μετακίνηση';
$_lang['Move <i>%filename</i> to'] = 'Μετακίνησε <i>%filename</i> στο';
$_lang['Move down'] = 'Κίνηση προς τα κάτω';
$_lang['Move to trash'] = 'Μετακίνησε στον κάλαθο';
$_lang['Move to trashbox?'] = 'Μετακίνηση στον κάλαθο;';
...
$_lang['My desktop'] = 'Η επιφάνεια εργασίας μου';
$_lang['My messages'] = 'Τα μηνύματα μου';
...
$_lang['Never connected'] = 'Ποτέ δεν συνδέθηκε';
$_lang['Never used'] = 'Δεν έχει χρησιμοποιηθεί ποτέ';
$_lang['New Class name'] = 'Όνομα νέας τάξης';
$_lang['New Registration allowed'] = 'Επιτρέπονται καινούργιες εγγραφές';
...
$_lang['New password'] = 'Καιούργιος κωδικός';
$_lang['New question'] = 'Καινούρια ερώτηση';
$_lang['New registration denied'] = 'Η καινούργια εγγραφή δεν εγκρίνετε';
...
$_lang['No courses'] = 'Δεν υπάρχουν μαθήματα';
...
$_lang['No event to display'] = 'Δεν υπάρχουν γεγονότα για προβολή';
...
$_lang['No message'] = 'Δεν υπάρχει μήνυμα';
...
$_lang['None'] = 'κανένας';
$_lang['Not a valid tool'] = 'Μη έγκυρο εργαλείο';
...
$_lang['Nothing to display'] = 'Τίποτα για προβολή';
...
$_lang['Now'] = 'Τώρα';
$_lang['Number of access'] = 'Αριθμοί πρόσβασης';
...
$_lang['Number of courses by access'] = 'Αριθμός μαθημάτων με βάση την πρόσβαση';
$_lang['Number of courses by enrollment'] = 'Αριθμός μαθημάτων με βάση την εγγραφή';
...
$_lang['Number of exercises per page'] = 'Αριθμός ασκήσεων ανα σελίδα';
$_lang['Number of learning paths using this module :'] = '
Αριθμός διαδρομών μάθησης που χρησιμοποιούν αυτή την ενότητα : ';
$_lang['Number of message per page'] = 'Αριθμός μηνυμάτων ανα σελίδα';
...
$_lang['Official code is'] = 'Ο επίσημος κωδικός είναι';
$_lang['Ok'] = 'Εντάξει';
$_lang['Old password'] = 'Παλαιός κωδικός';
$_lang['Old password is wrong'] = 'Ο παλαιός κωδικός είναι λανθασμένος
';
...
$_lang['Only not read'] = 'Μόνο όχι για διάβασμα';
$_lang['Only read'] = 'Μόνο για διάβασμα
';
$_lang['Only visible for teacher(s) and submitter(s)'] = 'Ορατό μόνο για καθηγητή(ες) και αποστολέα(εις)';
$_lang['Optional'] = 'Προαιρετικό';
$_lang['Options for announcements portlet'] = 'Επιλογές για την πύλη ειδοποιήσεων';
$_lang['Order'] = 'Εντολή ';
...
$_lang['Outbox'] = 'Εξερχόμενα';
$_lang['PHP configuration'] = 'Ρυθμίσεις PHP';
$_lang['PHP security information'] = 'Πληροφορίες ασφαλείας PHP';
$_lang['PHP system information'] = 'Πληροφορίες PHP';
$_lang['Package on server (zipped or not)'] = 'Πακέτο στον εξυπηρέτη (συμπιεσμένο ή όχι)';
$_lang['Package on the net (zip only)'] = 'Πακέτο στο διαδίκτυο (συμπιεσμένο μόνο)';
$_lang['Package on your computer (zip only)'] = 'Πακέτο στον υπολογιστή σας (συμπιεσμένο μόνο)';
$_lang['Page'] = 'Σελίδα';
...
$_lang['Path'] = 'Διαδρομή';
$_lang['Path to zip file or package directory on server'] = 'Διαδρομή στο συμπιεσμένο αρχείο ή στο πακέτο στον εξυπηρέτη';
...
$_lang['Platform activation'] = 'Ενεργοποίηση πλατφόρμας';
...
$_lang['Pretty URL using PATH_INFO (download.php/path/to/file.ext)'] = 'Όμορφη διεύθυνση URL χρησιμοποιά το PATH_INFO (download.php/path/to/file.ext)';
...
$_lang['Recipient'] = 'Παραλήπτης';
$_lang['Redirect to the file'] = 'Επαναπροσδιορισμός στο αρχείο';
...
$_lang['Remove from course'] = 'Αφαίρεση απο το μάθημα';
$_lang['Remove from the dock'] = 'Διέγραψε από την αποθήκη';
$_lang['Remove this module'] = 'Αφαίρεση αυτής της ενότητας
';
...
$_lang['Reserved to course members'] = 'Κρατημένο για τα μέλη του μαθήματος';
$_lang['Reserved to platform members'] = 'Κρατημένο στα μέλη της πλατφόρμας';
$_lang['Reset'] = 'Ρυθμιση εκ νέου';
$_lang['Restore'] = 'Επαναφορά';
...
$_lang['Revocation of %firstname %lastname'] = 'Κατάργηση του  %firstname %lastname';
$_lang['Right'] = 'Σωστό';
...
$_lang['Sample image'] = 'Δείγμα εικόνας';
...
$_lang['Search user to add to your course'] = 'Έρευνα χρήστη για να προσθεθεί στο μάθημα';
...
$_lang['Select date'] = 'Επιλογή ημερομηνίας';
$_lang['Select in drop down list'] = 'Επίλεξε στο κατάλολό λίστας πρώτα';
$_lang['Select interval'] = 'Επιλέξτε διάκενο';
$_lang['Select the tools you want to make visible for your user.'] = 'Επιλέξτε τα εργαλεία που θέλετε να κάνετε ορατά στον χρήστη σας';
$_lang['Select the way Claroline send files to a user.'] = 'Επιλέξτε το τρόπο που το Κλάρολαιν θα στέλνει αρχεία στον χρήστη';
$_lang['Selected Users'] = 'Επιλεγμένοι χρήστες';
$_lang['Send'] = 'Αποστολή';
$_lang['Send a message'] = 'Αποστολή μηνύματος';
$_lang['Send a message to all users'] = 'Αποστολή μηνύματος σε όλους τους χρήστες';
$_lang['Send a message to group'] = 'Αποστολή μηνύματος σε μια ομάδα';
$_lang['Send a message to the course'] = 'Αποστολή μηνύματος σε ένα μάθημα';
$_lang['Send a message to the user'] = 'Αποστολή μηνύματος σε ένα χρήστη';
$_lang['Send account information to user by email'] = 'Αποστολή πληροφοριών λογαριασμού στο χρήστη μέσω email';
$_lang['Send file using PHP (mask real file location)'] = 'Αποστολή αρχείου χρησιμοποιώντας PHP ';
$_lang['Send this announcement by internal message to registered students'] = 'Απόστειλε αυτήν την ειδοποίηση με εσωτερικό μήνυμα σε όλους τους εγγεγραμένους μαθητές';
...
$_lang['Standard URL using QUERY_STRING (download.php?url=/path/to/file.ext)'] = 'Βασική διεύθυνση URL χρησιμοποιώντας QUERY_STRING (download.php?url=/path/to/file.ext)';
...
$_lang['Style'] = 'Στύλ';
$_lang['Subject'] = 'Θέμα';
$_lang['Subject couldn\'t be empty'] = 'Το θέμα δεν μπορεί να είναι κενό';
...
$_lang['Submissions posted or modified after date :'] = 'Υποβολές αιτήσεων που αποστάληκαν ή αλλάχθηκαν μετα απο την ημερομηνία :';
...
$_lang['Teacher can export user list from his course'] = 'Ο δάσκαλος μπορεί να εξάγει την λίστα χρηστών απο το μάθημα του';
...
$_lang['Teachers can register new users to the campus'] = 'Οι δάσκαλοι μπορούν να εγγράψουν καινούργιους μαθητές στο πανεπιστήμιο';
$_lang['Technical Tools'] = 'Τεχνικά Εργαλεία ';
$_lang['Temporary folder missing'] = 'Προσωρινός κατάλογος δεν βρέθηκε';
$_lang['Text bottom'] = 'Κείμενο πυθμένα';
...
$_lang['Text top'] = 'Κείμενο κορυφής';
...
$_lang['The course is shown in the courses listing'] = 'Αυτό το μάθημα φαίνεται στην λίστα μαθημάτων';
...
$_lang['The message in now in your trashbox'] = 'Αυτό το μήνυμα είναι τώρα στον κάλαθο σου';
$_lang['The message sent but the notification by'] = 'Το μήνυμα στάληκε αλλά η ειδοποίηση από';
...
$_lang['The user will be created only if all informations are correct.'] = 'Ο χρήστης θα δημιουργηθεί αν όλες οι πληροφορίες είναι ορθές.';
...
$_lang['There is no submission available for download with these settings.'] = 'Δεν υπάρχει υποβολή αίτησης διαθέσιμη για κατέβασμα με αυτές τις ρυθμίσεις.';
$_lang['There is no user account with this email address.'] = 'Δεν υπάρχει λογαριασμός χρήστη με αυτή την διεύθυνση email.';
$_lang['There is no way to restore deleted messages.'] = 'Δεν υπάρχει τρόπος να επαναφέρετε διαγραμμένα αρχεία.';
...
$_lang['This feature is not ready.'] = 'Αυτή το χαρακτηριστικό δεν είναι διαθέσιμο';
$_lang['This is probably a bad idea to set as hidden'] = 'Αυτό είναι πιθανών μια λάθος ιδέα να το θέσετε κρυμμένο';
...
$_lang['This password is too simple or too close to the username, first name or last name.<br> Use a password like this <code>%passProposed</code>'] = 'Αυτός ο κωδικός είναι πολύ απλός ή πολύ κοντά στο όνομα χρήστη, όνομα ή επίθετο. <br> Χρησιμοποιήστε ένα κωδικό σαν και αυτό <code>%passProposed</code>';
...
$_lang['Time before really compute data. 86400 seconds = 1 day.'] = 'Ώρα πρίν τον υπολογισμό δεδομένων. 86400 δευτερόλεπτα = 1 μέρα.';
...
$_lang['Today'] = 'Σήμερα';
$_lang['Tool'] = 'Εργαλείο';
$_lang['Tool added to course'] = 'Το εργαλείο έχει προσθεθεί στο μάθημα';
$_lang['Tool list'] = 'Λίστα εργαλείων';
$_lang['Tool removed from course'] = 'Το εργαλείο έχει αφαιρεθεί απο το μάθημα';
$_lang['Tools'] = 'Εργαλεία';
$_lang['Tools currently in your course'] = 'Εργαλεία που υπάρχουν προς το παρόν στο μάθημα σας';
$_lang['Top'] = 'Κορυφή';
$_lang['Topic'] = 'Θέμα';
...
$_lang['Unable to copy file : %filename'] = 'Αδύνατο να αντιγράψει το αρχείο : %filename';
...
$_lang['Unable to create database tables for %label%'] = 'Αδύνατο να δημιουργήσει τους πίνακες της βάσης δεδομένων για το %label%';
...
$_lang['Unable to delete all events from the agenda'] = 'Αδύνατο να διαγράψει όλα τα γεγονότα απο το ημερολόγιο';
...
$_lang['Unknown recipient'] = 'Άγνωστος παραλήπτης';
$_lang['Unknown user'] = 'Άγνωστος χρήστης';
$_lang['Unlock'] = 'Ξεκλείδωμα';
$_lang['Unnamed module'] = 'Ανώνυμη ενότητα';
$_lang['Unnamed path'] = 'Ανώνυμη διαδρομή';
$_lang['Unordered list'] = 'Μη ταξινομημένη λίστα';
$_lang['Unread'] = 'Αδιάβαστο';
...
$_lang['Uploaded file should be an image'] = 'Το αρχείου που ανεβάζετε πρέπει να είναι εικόνα';
$_lang['Url of package'] = 'Διεύθυνση πακέτου';
$_lang['Use 0 to display all'] = 'Χρησιμοποιήστε το 0 για να τα προβάλετε όλα';
$_lang['Use SSL secure connection for login'] = 'Χρησιμοποιήστε SSL ασφαλισμένη ένωση για σύνδεση';
$_lang['Use TinyMCE editor compressor'] = 'Χρησιμοποιήστε επεξεργαστή συμπίεσης TinyMCE';
...
$_lang['User access to course'] = 'Πρόσβαση χρήστη σε μάθημα';
$_lang['User account creation allowed'] = 'Η δημιουργία λογαραριασμού χρήστη επιτράπηκε';
$_lang['User accounts merged'] = 'Οι λογαριασμοι των χρηστών που συγχωνεύτηκαν';
...
$_lang['User picture'] = 'Φωτογραφία χρήστη';
$_lang['User picture added'] = 'Η φωτογραφία του χρήστη έχει προσθεθεί';
$_lang['User picture deleted'] = 'Η φωτογραφία του χρήστη έχει διαγραφεί';
$_lang['User profile'] = 'Προφίλ Χρήστη';
$_lang['User profile box'] = 'Προφίλ χρήστη';
$_lang['User profile options'] = 'Επιλογές προφίλ χρήστη';
$_lang['User registered in a course having an unexisting (deprecated) status'] = 'Ο χρήστης που εγράφηκε στο μάθημα έχει ακατάλληλη(ανύπαρκτη) κατάσταση';
...
$_lang['User to keep not found'] = 'Ο χρήστης για να κρατηθεί δεν βρέθηκε';
$_lang['User to remove not found'] = 'Ο χρήστης για να αφαιρεθεί δεν βρέθηκε';
...
$_lang['Users access to course'] = 'Πρόσβαση χρηστών σε μάθημα';
$_lang['Users access to tools'] = 'Πρόσβαση χρηστών σε εργαλεία';
...
$_lang['Users statistics'] = 'Στατιστικα χρηστών';
...
$_lang['Vertical space'] = 'Κατακόρυφο διάστημα';
$_lang['View'] = 'Εμφάνιση';
$_lang['View all'] = 'Εμφάνιση όλων';
$_lang['View all right profile'] = 'Εμφάνιση όλων των προφίλ δικαιωμάτων';
$_lang['View all user\'s posts'] = 'Προβολή όλων των αποστολών ενός χρήστη';
$_lang['View by'] = 'Προβολή';
$_lang['View forum'] = 'Προβολή συζήτησης';
...
$_lang['View topic'] = 'Προβολή θέματος';
...
$_lang['Visible in all courses on install <small>(course tool only)</small>'] = 'Ορατό σε όλα τα μαθήματα στην εγκατάσταση <small>(εργαλείο μαθήματος μόνο)</small>';
$_lang['Visible on  each course on install <small>(tool only)</small>'] = 'Ορατό σε όλα τα μαθήματα στην εγκατάσταση <small>(εργαλείο μόνο)</small>';
$_lang['Visible only to people on the user list'] = 'Ορατό σε όλους τους ανθρώπους που βρίσκονται στην λίστα χρηστών';
...
$_lang['Warning : chosen date is in the future'] = 'Προειδοποίηση : η επιλεγμένη ημερομηνία είναι στο μέλλον';
...
$_lang['Warning: When you delete a message keep in mind that it will be deleted for every user.
        <br /><br />You cannot retrieve deleted messages!'] = 'Προειδοποίηση : Όταν διαγράφεις ένα μήνυμα πρέπει να έχετε υπόψη ότι διαγράφετε για κάθε χρήστη.        <br /><br />Δεν μπορείτε να επαναφέρετε διαγραμμένα αρχεία!';
...
$_lang['Where is your package ?'] = 'Που είναι το πακέτο σου;';
...
$_lang['Works uploaded by the student in the name of \'Authors\''] = 'Οι εργασίες που ανέβηκαν απο τον μαθητή στο όνομα τους \"Δημιουργοί\"';
...
$_lang['You also need to configure your web server to allow SSL connections to the auth/login.php script !'] = 'Πρέπει να ρυθμίσεις τον εξυπηρέτη ιστοσελίδων να δέχετε ενώσεις SSL στο Script auth/login.php!';
...
$_lang['You are not in a course'] = 'Δεν είσαστε σε μάθημα';
$_lang['You are now a member of this group.'] = 'Είσαι τώρα μέλος της ομάδας';
$_lang['You are receiving this notification because you are watching a topic on the forum of one of your courses.'] = 'Λαβάνεις αυτήν την ειδοποίηση επειδή παρακολουθείς ένα θέμα απο την συζήτηση κάποιου απο τα μαθήματα σου.';
$_lang['You can also change the access rights for the different user profiles.'] = 'Μπορείς να αλλάξεις τον έλεγχο πρόσβασης για τα διαφορετικά προφίλ χρηστών.';
$_lang['You can choose a title and a description for the wiki :'] = 'Μπορείτε να διαλέξετε τίτλο και περιγραφή για την εγκυκλοπαίδεια.';
...
$_lang['You cannot add module. Change this in configuration.'] = 'Δεν μπορείτε να προσθέσετε ενότητα. Αλλάξτε αυτό στις ρυθμίσεις.';
...
$_lang['You didnt choose any file to send, or file is too big'] = 'Δεν επιλέξατε αρχείο για να στείλετε, η το αρχείο σας είναι πολύ μεγάλο';
...
$_lang['You must be in a group to send a message to a group'] = 'Πρέπει να είσαστε σε ομάδα για να στείλετε μήνυμα σε μια ομάδα.';
...
$_lang['Your file has been renamed to %filename'] = 'Το αρχείο σας έχει μετονομασθεί σε %filename';
...
$_lang['delete failed for module %module'] = 'διαγραφή αποτυχημένη για την ενότητα %module';
$_lang['delete succeeded for module %module'] = 'διαγραφή επιτυχημένη για την ενότητα %module';
...
$_lang['max size %width%x%height%, %size% bytes'] = 'μέγιστο μέγεθος  %width%x%height%, %size% μπάιτς';
$_lang['max. 12 characters, e.g. <em>ROM2121</em>'] = 'με λατινικά γράμματα μέχρι 12 χαρακτήρες, π.χ. <i>FYS1234</i>';
$_lang['message id'] = 'αριθμός μηνύματος';
$_lang['min.'] = 'λεπ.';
...
$_lang['to'] = 'σε';
$_lang['tutor'] = 'καθηγητής';
$_lang['uncompress zipped (.zip) file on the server'] = 'αποσυμπίεση του αρχείου (.zip) στον εξυπηρέτη';
$_lang['unknow recipient type'] = 'άγνωστος τύπος παραλήπτη';
$_lang['unknown'] = 'άγνωστος';
