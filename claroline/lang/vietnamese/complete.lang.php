...
$_lang['Add a user'] = 'Thêm user';
$_lang['Add an event'] = 'Thêm sự kiện';
...
$_lang['Announcement has been modified'] = 'Thông báo đã chỉnh sửa';
$_lang['Announcements'] = 'Thông báo';
$_lang['Announcements list has been cleared up'] = 'Danh mục các thông báo đã được xoá';
...
$_lang['Author(s)'] = 'Người gửi';
$_lang['Back'] = 'Quay lại';
$_lang['Back to list'] = 'Trở về danh sách user';
$_lang['Back to my personal course list'] = 'Trở về danh mục khoá học cá nhân';
$_lang['Back to user list'] = 'Trở về danh sách người dùng';
$_lang['Cancel'] = 'Cancel';
...
$_lang['Comment modified'] = 'Đã sửa phần ghi chú';
$_lang['Confirmation'] = 'Xác nhận lại';
$_lang['Corresponds to'] = 'Tương ứng với';
$_lang['Course'] = 'Website ';
$_lang['Course access'] = 'Truy cập vào khoá học này';
$_lang['Course administrator only'] = 'Chỉ dành cho người quản trị';
$_lang['Course code'] = 'Mã khoá học';
$_lang['Course description'] = 'Mô tả khoá học';
$_lang['Course manager'] = 'Quản lý khoá họcr';
$_lang['Course title'] = 'Tên khoá học';
$_lang['Courses'] = 'Khoá học';
$_lang['Courses not used'] = 'Courses not used';
$_lang['Courses without a lecturer'] = 'Courses without professor';
$_lang['Create'] = 'create';
$_lang['Create a course site'] = 'Tạo một khoá học';
$_lang['Create a course website'] = 'Tạo một website cho khoá học mới';
$_lang['Create directory'] = 'Tạo thư mục';
...
$_lang['Delete the whole course website'] = 'Xoá toàn bộ website của khoá học';
$_lang['Denied'] = 'Bị cấm';
...
$_lang['Document deleted'] = 'Tài liệu đã xoá';
...
$_lang['Element moved'] = 'Đã di chuyển xong';
$_lang['Element renamed'] = 'Đã đổi tên xong';
...
$_lang['Expected choice'] = 'Cần chọn';
$_lang['Fill groups (automatically)'] = 'Fill groups';
$_lang['Fill in blanks'] = 'Điền vào chỗ trống';
$_lang['Filter'] = 'Lọc';
$_lang['Finish'] = 'Kết thúc';
$_lang['First name'] = 'Tên';
$_lang['Follow courses'] = 'Tham gia các khoá học (HS)';
$_lang['Forum'] = 'Forum';
...
$_lang['Group management'] = 'Quản trị nhóm';
...
$_lang['He or she will receive email confirmation with login and password'] = 'Người dùng sẽ nhận được email thông báo login và password';
$_lang['Heading'] = 'Heading';
$_lang['Help'] = 'Help';
$_lang['Hits'] = 'Hits';
$_lang['Home page help'] = 'Help Home Page';
$_lang['Hour'] = 'Giờ';
$_lang['Information to give to students'] = 'Thông tin đến học sinh';
...
$_lang['Login'] = 'login';
$_lang['Login request'] = 'Cần thiết Login ';
$_lang['Logins'] = 'Logins';
...
$_lang['Max file size'] = 'Kích thước tối đa của file là';
$_lang['Max.'] = 'max.';
$_lang['Message body'] = 'N?i dung Bài';
$_lang['Missing'] = 'missing';
$_lang['Missing images detected'] = 'Không thấy hình';
$_lang['Modifies this announcement'] = 'Sửa thông báo này';
$_lang['Modify'] = 'Modify';
$_lang['Month'] = 'Tháng';
$_lang['Move'] = 'Di chuyển';
$_lang['Move down'] = 'Di chuyển xuống';
$_lang['Move up'] = 'Di chuyển lên';
...
$_lang['New question'] = 'Câu hỏi mới';
$_lang['New topic'] = 'Ch? d? m?i';
$_lang['Newest first'] = 'Từ mới đến cũ';
$_lang['Next'] = 'Tiếp';
$_lang['Next day'] = 'Ngày kế tiếp';
$_lang['Next month'] = 'Tháng kế tiếp';
$_lang['Next week'] = 'Tuần kế tiếp';
$_lang['Next year'] = 'Năm kế tiếp';
$_lang['No'] = 'No';
$_lang['No result'] = 'Không có kết quả';
$_lang['No way'] = 'Không được phép';
$_lang['None'] = 'Không';
...
$_lang['Number of courses by faculty'] = 'Number of courses by faculte';
...
$_lang['On'] = 'On';
$_lang['On an unique page'] = 'Trên một trang';
$_lang['One question per page (sequential)'] = 'Mỗi câu hỏi một trang (liên tiếp)';
$_lang['Optional'] = 'Tuỳ chọn';
$_lang['Orphan questions'] = 'Câu hỏi mồ côi';
$_lang['Other'] = 'Khác';
...
$_lang['The upload has failed. There is not enough space in your directory'] = 'Upload có lỗi. Không đủ chỗ trống trong thư mục';
$_lang['The upload is finished'] = 'Upload xong';
...
$_lang['This is your account Login-Pass'] = 'Đây là tên đăng nhập và mật khẩu của bạn';
$_lang['This user name is already taken'] = 'This username is already taken';
$_lang['Title'] = 'Tiêu đề';
$_lang['To'] = 'đến';
$_lang['Tools'] = 'Tools';
$_lang['Topic'] = 'Ch? d?';
...
$_lang['Topics'] = 'Ch? d?';
$_lang['Total'] = 'Total';
$_lang['Total Clicks'] = 'Tổng số lượt truy cập';
...
$_lang['Unregister'] = 'Thôi đăng ký';
$_lang['Unsubscribe'] = 'Thôi đăng ký';
$_lang['Up'] = 'Up';
$_lang['Upgrade'] = 'Nâng cấp';
$_lang['Upload file'] = 'Upload file lên máy chủ web';
$_lang['User\'s course'] = 'Các khoá học';
$_lang['Username'] = 'Username';
$_lang['Users'] = 'Users';
$_lang['Users Downloads'] = 'Số lần  Downloads';
$_lang['Users help'] = 'Help Users';
$_lang['Users not in this group'] = 'Users not in this group';
$_lang['Users\' Clicks'] = 'Số lượt truy cập của user';
$_lang['View by'] = 'Xem bởi';
$_lang['View list of all tools'] = 'Xem danh sách tất cả công cụ';
$_lang['View my statistics'] = 'Xem thống kê';
...
$_lang['Year'] = 'Năm';
$_lang['Yes'] = 'Yes';
$_lang['You are now a member of this group.'] = 'You are now member of this group';
$_lang['You can now create your  course'] = 'You can now go to create  your  course';
...
$_lang['blockDocumentsHelp'] = '<p>The Documents tool is similar to the FileManager of
...
<hr noshade size=1>';
$_lang['blockHomepageHelp'] = 'For more convenience, claroline tools contain default entries.
...
$_lang['sampleForumMainCategory'] = 'Nhóm diễn đàn chính';
$_lang['sampleForumMessage'] = 'Khi bạn xoá, các bài trong diễn đàn cũng tự động xoá theo.';
